...
def inicio():
    if 'conectado' in session:
        comentarios = sql_lista_comentariosBD()
        noticias = sql_lista_noticiasBD()
        categorias = sql_lista_categoriasBD()  # Obtener la lista de categorías
        return render_template('public/base_cpanel.html', dataLogin=dataLoginSesion(), noticias = noticias, categorias = categorias, comentarios = comentarios)
    else:
